...
public class GuestsController {
    ...
    GuestDTO create(@Valid @RequestBody GuestCreateDTO guestCreateDTO) {
        ...
        guest.setClubCard(guestCreateDTO.getClubCard());
        guest.setCardValidUntil(guestCreateDTO.getCardValidUntil());
