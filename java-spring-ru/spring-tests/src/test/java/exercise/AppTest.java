...
public class AppTest {
    ...
    void testGetAllPerson() throws Exception {
        var existingUserEmail = "lommoc@yahoo.com";
    ...
    void testUpdatesPerson() throws Exception {
        ...
        MockHttpServletResponse responsePost = mockMvc
                .perform(
                        patch("/people/" + existingUserId)
                            .contentType(MediaType.APPLICATION_JSON)
                            .content("{\"email\": \"walker@yahoo.com\", \"firstName\": \"Johny\", \"lastName\": \"Walker\"}")
                )
                .andReturn()
                .getResponse();
