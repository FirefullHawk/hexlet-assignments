...
class ValidationTest {
    ...
    void testAdvancedValidator() {
        ...
        Address address1 = new Address("Rus", "Ufa", "Lenina", "54", null);
        Map<String, String> result1 = Validator.advancedValidate(address1);
        Map<String, String> expected1 = Map.of("country", lesser, "city", lesser);
        assertThat(result1).isEqualTo(expected1);

        Address address2 = new Address("Russia", "Moscow", null, "54", null);
        Map<String, String> result2 = Validator.advancedValidate(address2);
        Map<String, String> expected2 = Map.of("street", notNull);
        assertThat(result2).isEqualTo(expected2);
    }
    // END
}
